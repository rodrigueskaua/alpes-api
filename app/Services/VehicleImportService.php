    ...
    public function import(array $data): Vehicle
    {
        return Vehicle::updateOrCreate(
            ...
            [
                ...
                'optionals' => isset($data['optionals']) ? json_encode($data['optionals'], JSON_THROW_ON_ERROR) : json_encode([]),
                ...
                'fuel' => $data['fuel'] ?? null,
                'photos' => isset($data['fotos']) ? json_encode($data['fotos'], JSON_THROW_ON_ERROR) : json_encode([]),
            ]
        );
    }
}
